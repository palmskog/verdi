...
Proof using tot_map_name_inverse_inv tot_init_handlers_eq.
apply functional_extensionality => n.
...
Proof using tot_net_handlers_eq tot_map_name_inverse_inv tot_map_name_inv_inverse tot_input_handlers_eq.
move => net net' tr.
case => {net net' tr}.
...
Proof using tot_net_handlers_eq tot_map_name_inverse_inv tot_map_name_inv_inverse tot_input_handlers_eq tot_init_handlers_eq.
move => net tr H_step.
...
Theorem step_m_tot_mapped_simulation_2 :
  forall net net' out mnet mout,
      ...
      exists mnet',
        ...
        tot_map_net mnet' = net'.
Proof using tot_net_handlers_eq tot_map_output_injective tot_map_name_inverse_inv tot_map_name_inv_inverse tot_input_handlers_eq.
...
Proof using tot_reboot_eq tot_net_handlers_eq tot_map_name_inverse_inv tot_map_name_inv_inverse tot_input_handlers_eq.
...
Proof using tot_reboot_eq tot_net_handlers_eq tot_map_name_inverse_inv tot_map_name_inv_inverse tot_input_handlers_eq tot_init_handlers_eq.
...
Theorem step_f_tot_mapped_simulation_2 :
  forall net net' failed failed' out mnet mfailed mfailed' mout,
      ...
      exists mnet',
        ...
        tot_map_net mnet' = net'.
Proof using tot_reboot_eq tot_net_handlers_eq tot_map_output_injective tot_map_name_inverse_inv tot_map_name_inv_inverse tot_input_handlers_eq.
